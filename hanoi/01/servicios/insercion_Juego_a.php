...
$t_juego = $_POST["t_juego"];
$clicks = $_POST["clicks"];
$id_partida = $_POST["id_partida"];
$estado_agente = $_POST["estado_agente"];





$sql = "INSERT INTO juegos_anonimos (id_jugador_a,  numero_jugadas, parametro1, parametro2, parametro3, parametro4, grafo, agente, gano, numex, partida, t_juego,  clicks,  id_partida, estado_agente)
VALUES ('$id_jugador_a', '$numero_jugadas', '$parametro1', '$parametro2', '$parametro3', '$parametro4', '$grafo', '$agente' , '$gano', '$numex','$partida','$t_juego','$clicks','$id_partida','$estado_agente')";
