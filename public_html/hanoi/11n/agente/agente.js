  ...
  if (idioma == 'es')
  {
    if (metrica_Regla0 != 0 && dp.movil == true)
    {
      ...
      if (MOCHS[MOCHS.length -1 ] == 0)
      {
        ...
        if(con_grafo ==1)
        {
          $("#msj-agente").html(texto_agente+" <div class = \"bob-agente\" id = \"bob-agente"+bob_agente_No+"\" > "+bob_agente_No+")Esta no jugada te acerca a resolver el juego. </br> </br>Si observas el grafo  podrás ver que hay mejores opciones.</div> <p></p>");
        }
        else
        {
         $("#msj-agente").html(texto_agente+" <div class = \"bob-agente\" id = \"bob-agente"+bob_agente_No+"\" > "+bob_agente_No+")ESTA JUGADA NO TE ACERCA A RESOLVER EL JUEGO, EXPOLAR OTRAS OPCIONES!!</div> <p></p>");
       }
      ...
      if(MOCHS.length !=0)
      {
        ...
        if(con_grafo ==1)
        {
          $("#msj-agente").html(texto_agente+" <div class = \"bob-agente\" id = \"bob-agente"+bob_agente_No+"\" > "+bob_agente_No+")Esta jugada te acerca a resolver el juego. </br> ¡Sigue adelante!. </br>Si observas el grafo  notarás que tu \"posición\" se acercó un poco más a la meta.</div> <p></p>");
        }
        else
        {
         $("#msj-agente").html(texto_agente+" <div class = \"bob-agente\" id = \"bob-agente"+bob_agente_No+"\" > "+bob_agente_No+")ESTA JUGADA TE ACERCA A RESOLVER EL JUEGO, SIGUE ADELANTE.</div> <p></p>");
       }
       $(".bob-agente").focus();
       $("#msj-agente").scrollTop(1000000);
       $("#bob-agente"+bob_agente_No).css("color" , "#000000");
...

{
  ...
  if(con_grafo ==1)
  {
    ...
    $("#msj-agente").html(texto_agente+" <div class = \"bob-agente\" id = \"bob-agente"+bob_agente_No+"\" >"+bob_agente_No+") Ce jeu ne vous rapproche pas de la résolution du jeu. </br> Si vous regardez le graphique, vous remarquerez qu'il existe de meilleures options </div> <p></p>");
  }
  else
  {
    $("#msj-agente").html(texto_agente+" <div class = \"bob-agente\" id = \"bob-agente"+bob_agente_No+"\" >"+bob_agente_No+") CE JEU N'EST PAS PRÈS DE RÉSOUDRE LE JEU, D'EXPOLER D'AUTRES OPTIONS</div> <p></p>");
  ...
  if(MOCHS.length !=0){
    ...
    if(con_grafo ==1)
    {
      $("#msj-agente").html(texto_agente+" <div class = \"bob-agente\" id = \"bob-agente"+bob_agente_No+"\" > "+bob_agente_No+")Ce mouvement vous rapproche de la résolution du jeu. </br> Continuez ! </br> Si vous regardez le graphique, vous remarquerez que votre \"position \" s'est un peu rapprochée du but.</div> <p></p>");
    }
    else
    {
      $("#msj-agente").html(texto_agente+" <div class = \"bob-agente\" id = \"bob-agente"+bob_agente_No+"\" >"+bob_agente_No+") CE JEU VOUS REND PLUS PROCHE DE LA RÉSOLUTION DU JEU, CONTINUEZ.</div> <p></p>");
    }
...
else
{
  if(metrica_Regla0 == 0 && dp.movil == true){
    ...
    escuchar();
    var texto_agente = $("#msj-agente").html();
    $("#msj-agente").html(texto_agente+" <div class = \"bob-agente\" id = \"bob-agente"+bob_agente_No+"\" > "+bob_agente_No+")CE JEU BRISE LES RÈGLES !! </div> <p></p>");
    $(".bob-agente").focus();
    $("#msj-agente").scrollTop(1000000);
    $("#bob-agente"+bob_agente_No).css("color" , "#ff1010");
    $("#bob-agente"+(bob_agente_No-1)).css("color" , "#909090");
  ...
  else
  {
    ...
    escuchar();
    var texto_agente = $("#msj-agente").html();
    $("#msj-agente").html(texto_agente+" <div class = \"bob-agente\" id = \"bob-agente"+bob_agente_No+"\" > "+bob_agente_No+")LE JEU QUE VOUS ESSAYEZ BRISE LES RÈGLES !! </div> <p></p>");
    $(".bob-agente").focus();
    $("#msj-agente").scrollTop(1000000);
    $("#bob-agente"+bob_agente_No).css("color" , "#ff1010");
    $("#bob-agente"+(bob_agente_No-1)).css("color" , "#909090");;
