...
<body>
    ...
    <div class="preguntas">
   <label>¿Con qué frecuencia usas aplicaciones de Inteligencia Artificial (IA) para tareas escolares?</label>
    <ul>
      ...
      <li><input type="radio" name="pregunta_6" value="4"> Nunca </li>
    </ul>
</div>
