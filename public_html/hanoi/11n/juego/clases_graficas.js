...
/////Dibuja las segerencias y estado actual
    ...
    circle(map(xx[numex], minx, maxx, 600, 1200), map(yy_mod[numex], miny, maxy, 50, 510), 5);
    ...
    if (ruta.length>0) 
    {
      ...
      {
        circle(map(xx[(ruta[i]-1)], minx, maxx, 600, 1200), map(yy_mod[(ruta[i]-1)], miny, maxy, 50, 510), 7);
      }
      fill(0);
      stroke(0);
    }
