...
function setup() {
 ...
 // var cnv = createCanvas(windowWidth, windowHeight);
  cnv = createCanvas(950, 210);
  cnv.position(ancho*0.13, alto*0.46);
...
function botonMasBloquesQ(){
  ...
  botonMasBloques.position(340,450);
  botonMasBloques.size(100,50);
  botonMasBloques.style("background-color", "#439304");
  botonMasBloques.style("color", "#fff");
  botonMasBloques.style("border-radius", "15px");
  botonMasBloques.mousePressed(contadorIncrementa);
}
function botonMenosBloquesQ(){
  botonMenosBloques = createButton("Menos Bloques");
  botonMenosBloques.position(540,450);
  botonMenosBloques.size(100,50);
  botonMenosBloques.style("background-color","#439304");
  botonMenosBloques.style("color", "#fff");
  botonMenosBloques.style("border-radius", "15px");
  botonMenosBloques.mousePressed(contadorDecrementa);
}
function botonReIniciarQ(){
  botonReinicioBloques = createButton("Reiniciar");
  botonReinicioBloques.position(740,450);
  botonReinicioBloques.size(100,50);
  botonReinicioBloques.style("background-color", "#439304");
  botonReinicioBloques.style("color", "#fff");
  botonReinicioBloques.style("border-radius", "15px");
  botonReinicioBloques.mousePressed(llenarVectorEstadoInicial);
}
